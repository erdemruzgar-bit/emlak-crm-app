...
function DetailChip({
  ...
  return (
    <div className="bg-surface-container-low p-4 rounded-2xl flex items-center gap-3 group hover:bg-surface-container transition-all border border-outline-variant/5">
      <div className="w-10 h-10 bg-surface-container-lowest rounded-xl flex items-center justify-center text-primary shadow-sm group-hover:scale-110 transition-transform">
